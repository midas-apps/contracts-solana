...
import { sendSquadsTxWithTimelock } from "./testers/squads.testers";
...
describe('Squads multisig', () => {
    ...
    describe('timelock', () => {
        it('regular sol transfer with timelock', async () => {
            ...
            const { mutlisigPda, getMutlisigData, authority, regularAccounts, context } = fixture;
        ...
        it('should fail: sol transfer execite from non-member', async () => {
            const fixture = await squadsFixture();
            const { mutlisigPda, getMutlisigData, authority, regularAccounts, context } = fixture;
