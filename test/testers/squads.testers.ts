...
export const sendSquadsTxWithTimelock = async (
  fixture: SquadsFixtureReturnType,
  {
  ...
  const createdProposal = await multisig.accounts.Proposal.fromAccountAddress(
    squadsConnection,
    proposalPda,
  );
...
export const sendSquadsConfigurationTxWithTimelock = async (
  fixture: SquadsFixtureReturnType,
  {
    waitForTimelock = true,
    actions,
