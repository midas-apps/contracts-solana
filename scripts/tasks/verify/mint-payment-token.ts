...
// yarn tsx scripts/tasks/verify/mint-payment-token.ts --network devnet --payment-token USDC --amount 1000
// yarn tsx scripts/tasks/verify/mint-payment-token.ts --network devnet --payment-token USDC --amount 1000 --recipient <address>
