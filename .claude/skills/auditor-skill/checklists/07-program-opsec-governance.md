...
- [ ] **OPS-054**: Program upgrades — timelock duration: **\_** hours/days
- [ ] **OPS-055**: Fee changes — timelock duration: **\_** hours/days (or "none" — flag if none)
- [ ] **OPS-056**: Manager changes — timelock duration: **\_** hours/days (or "none")
- [ ] **OPS-057**: Whitelist changes — timelock duration: **\_** hours/days (or "none")
- [ ] **OPS-058**: Treasury address changes — timelock duration: **\_** hours/days (should be "immutable")
