...
Written by /threat-model to audit\_<n>/threat-model.md. Built BEFORE the manual
...
Consumes: audit*<n>/intake.md §6 (trust-model inputs) and
audit*<n>/worksheets/context/\* (invariants, assumptions, external-interaction risks).
================================================================================
-->
