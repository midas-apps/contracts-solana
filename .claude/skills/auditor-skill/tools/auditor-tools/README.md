...
- **`audit-scan`** — parse a codebase and emit the _risky surface_ as one JSON
...
```jsonc
{
  ...
  "pdas": [
    { "struct": "string", "field": "string", "seeds": ["string"], "file": "string", "line": 0 },
  ],
  ...
  "arithmetic_sites": [
    { "file": "string", "line": 0, "op": "+|-|*|/|+=|-=|*=|/=", "snippet": "string" },
  ],

  // `.unwrap()`, `.expect(..)`, index exprs `x[y]`, and the
  // `panic!`/`unreachable!`/`unwrap!` macros.
  "panic_sites": [
    { "file": "string", "line": 0, "kind": "unwrap|expect|index|panic", "snippet": "string" },
  ],
  ...
  "cpi_sites": [
    { "file": "string", "line": 0, "kind": "invoke|invoke_signed|CpiContext", "snippet": "string" },
  ],

  // every `ItemFn` and `ImplItemFn`.
  "functions": [{ "name": "string", "file": "string", "line": 0, "pub": false }],
}
```
