...
This vector is about the SIGNING GATE: is the fully-built transaction simulated, decoded, and allowlist-checked _by the component holding the key_ immediately before the signature? It complements 110 (key custody/caps): caps bound the loss, this bounds _what_ can be authorized at all.
