...
This is distinct from KV-016 (mint/authority mismatch): here the mint and owner can be _correct_, but the account is not the canonical ATA the protocol's off-chain/accounting layer expects.
