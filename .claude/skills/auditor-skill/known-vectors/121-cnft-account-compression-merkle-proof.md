...
- ✅ PASS: No window where a proof validated against root _R_ is applied after the tree advanced to _R'_ in a way that double-applies or resurrects a leaf (mark/consume is bound to the same root state it validated against)
