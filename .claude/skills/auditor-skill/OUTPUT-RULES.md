...
[PASS*] AV-001: Ownership checked via Account<T> — _confidence: medium, complex macro usage
[FAIL-6_] AR-015: Division without zero check — \*confidence: high, clear in code
