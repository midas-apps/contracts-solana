...
security methodology it does so by _reference_ — no third-party text is copied
...
Several Trail of Bits _methodology patterns_ are additionally re-implemented
