...
holds or transfers the _wrong_ authority loses custody of stake. For every stake account the
...
The conservation invariant (§2) must hold _through_ every interleaving, not just at rest.
