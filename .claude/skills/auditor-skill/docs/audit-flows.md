...
- **Design pass before implementation pass.** The economic architecture, oracle-manipulation surface, and state machines are reviewed _first_ (a broken incentive on clean code is a finding in its own right), then the line-by-line checklist walk is aimed at the surfaces the design pass flagged.
