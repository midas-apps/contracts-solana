...
function TipButton({ to }: { to: string }) {
  ...
  const {
    ...
    error,
    data: signature,
  } = useAction(async (signal: AbortSignal, recipient: string) => {
