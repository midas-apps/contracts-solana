...
use anchor_spl::{token_2022::{thaw_account, ThawAccount}, token_interface::{Mint as SplMint, TokenAccount, TokenInterface}};
...
pub struct Thaw<'info> {
    ...
    #[account(
        ...
        associated_token::authority = to_thaw,
    )]
    pub to_thaw_ata: Box<InterfaceAccount<'info, TokenAccount>>,
    ...
    thaw_account(
        CpiContext::new_with_signer(
            ...
            ThawAccount {
                ...
                account: ctx.accounts.to_thaw_ata.to_account_info(),
            },
            &[&[ 
